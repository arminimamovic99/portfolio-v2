...
export default function Aurora(props: AuroraProps) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // WebGL unsupported/blocked: skip the effect and keep the plain background.
      return;
    }
    ...
    // Only `amplitude` re-creates the WebGL context; blend/colorStops/lightMode
    // update live via propsRef inside the render loop instead.
