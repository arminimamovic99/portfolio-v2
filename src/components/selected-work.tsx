    ...
    <>
      <div style={style} className="flex h-full flex-col gap-3">
        ...
        <article
          ...
          className={`group flex flex-1 flex-col gap-3 rounded-2xl border border-border bg-background-elevated p-6 transition-all duration-300 hover:-translate-y-1 hover:border-accent/60 hover:shadow-[0_0_50px_-20px_var(--color-accent)] ${
